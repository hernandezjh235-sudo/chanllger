...
REFRESH_ANCHOR = "if refresh_btn:\n    all_rows = []"

BLOCK = r'''
# =============================================================================
# CHALLENGER_UD2_MANUAL_REFRESH_STATE_V2_2026_08_28
# Runtime/state only. Projection math is untouched.
# - no passive/background Savant network refresh
# - Savant may refresh only when the user explicitly refreshes the live board
# - live board is checkpointed so Save/reruns/reconnects do not blank it
# =============================================================================
try:
...
def _state_v2_refresh_savant_for_board():
    """Only called by the explicit live-board refresh button."""
