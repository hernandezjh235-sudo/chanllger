#!/usr/bin/env python3
"""Challenger Savant refresh v6.

Uses 4-day Statcast detail windows for batter-vs-pitcher-hand reconstruction.
This stays safely below Savant's 25,000-row CSV cap on normal full MLB slates.
The cap detector remains mandatory: a capped response is rejected rather than
published. All existing v3 integrity checks remain active.
"""
...
def _event_split_totals_four_day() -> pd.DataFrame:
...
v3._event_split_totals = _event_split_totals_four_day
